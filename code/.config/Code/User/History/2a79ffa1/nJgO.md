...
`make` is a function in Go that allows to creates slices by defining the type, size and capacity in advance.
The example below helps get a better understing of the capacity too:
