...
- Applied using the `'use server'` directive
- Used inside functions to tell NextJS that the function is only executed on a server
- The `async` keyboard is also necessary
