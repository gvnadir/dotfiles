...
// Using Link from NextJS will allow to pre-fetching the content of the page when hovering over the button. Furthemore, it will use client-side rendering for showing the new page, it means that just the JavaScript code for showing that page will be requested and showed without refreshing the entire page with a new HTML page
