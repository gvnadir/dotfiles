...
- Components that uses effects, events or every peace of code that runs on the browser, must be declared as client-side components by declaring the `'use client'` in the JS/TS file.