...
- When we have a dynamic path without knowing its value, it is possible to define a placeholder using the `[]` syntax when defining the filename

> e.g. 
> - app
> 	- blog --> localhost/blog
> 		- [slug] --> localhost/blog/post-1